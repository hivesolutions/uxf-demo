<section id="responsive-sec">
    ...
    <div class="section-contents">
        ...
        <p>
            Some classes are also added to the <span class="highlight">body</span> based on the
            screen's dimensions. The pixel ranges can be overrided by setting the appropriate data
            attributes. The <span class="highlight">retina-s</span> class is added in retina screens.
        </p>
