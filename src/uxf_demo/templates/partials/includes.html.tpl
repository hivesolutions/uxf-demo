...
<link rel="stylesheet" type="text/css" href="{{ url_for('static', filename = 'libs/uxf/styles/omni/css/ux.css') }}" />
...
<script type="text/javascript" src="{{ url_for('static', filename = 'js/pixels.js') }}"></script>
