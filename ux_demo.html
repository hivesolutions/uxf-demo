...
<html lang="en">
    <head>
        ...
        <!-- css inclusion -->
        <link rel="stylesheet" type="text/css" href="bin/css/ux-min.css" />
        <link rel="stylesheet" type="text/css" href="bin/styles/omni/css/ux-min.css" />
        <link rel="stylesheet" type="text/css" href="styles/base/css/ux.css" />  <!-- @TODO REMOVE THIS THING -->
        <link rel="stylesheet" type="text/css" href="extras/css/layout.css" />
        <link rel="stylesheet" type="text/css" href="extras/css/prettify.css" />

        <!-- favicon inclusion -->
        <link rel="shortcut icon" href="bin/images/ux.ico" />

        <!-- javascript inclusion -->
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
        <script type="text/javascript" src="bin/js/ux-min.js"></script>
    ...
    <body class="ux">
        <div class="content-bar top-bar">
            <div class="container-960">
                <img class="logo" src="bin/images/ux-logo.png" />
                <ul class="navigation">
